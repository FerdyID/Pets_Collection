...
public class EditorActivity extends AppCompatActivity {
    ...
    private EditText mName, mSpecies, mBirth;
    private CircleImageView mPicture;
    private FloatingActionButton mFabChoosePic;
    private int mGender = 0;
    private String name, species, picture, birth;
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            requestOptions.skipMemoryCache(true); //hapus image cache
            requestOptions.diskCacheStrategy(DiskCacheStrategy.NONE); //tidak menyumpan data ke cache
            requestOptions.placeholder(R.drawable.logo); //load new image
    ...
    private void postData(final String key) {
        ...
        Call<Pets> call = apiInterface.insertPet(key, name, species, gender, birth, picture);
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Pets> call = apiInterface.updatePet(key, id, name, species, gender, birth, picture);
